        ...
        <form ref={formRef} className="space-y-6" onSubmit={handleSubmit} noValidate>
            ...
            >
                ...
                <input
                    ...
                    className={`${inputClass} ${errors.from_name ? "border-red-400! dark:border-red-400/60!" : ""}`}
            ...
            >
                ...
                <input
                    ...
                    className={`${inputClass} ${errors.from_email ? "border-red-400! dark:border-red-400/60!" : ""}`}
            ...
            >
                ...
                <textarea
                    ...
                    className={`${inputClass} resize-none ${errors.message ? "border-red-400! dark:border-red-400/60!" : ""}`}
                        ...
                        <div className="md:col-span-3 space-y-6 text-center md:text-left">
                            ...
                            <Reveal delay={0.2}>
                                <p className="text-brand-deep/75 dark:text-cream/70 leading-loose">
                                    ...
                                    the relationships that taught me, and the healing that transformed bg-linear-to-br
                                </p>
                            </Reveal>
                            <Reveal delay={0.25}>
                                <p className="text-brand-deep/75 dark:text-cream/70 leading-loose">
